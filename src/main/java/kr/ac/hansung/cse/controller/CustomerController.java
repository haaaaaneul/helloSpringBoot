...
public class CustomerController {
	...
	@GetMapping(value="/customers", produces=MediaType.APPLICATION_JSON_VALUE)	//생성되는 response body가 JASON 타입
	public ResponseEntity<List<Customer>>  getAll() {
		...
		customers.forEach(list::add); //각각을  list에 넣음
	...
	public ResponseEntity<Void> postCustomer(@RequestBody Customer customer) {
		...
		repository.save(new Customer(firstName, lastName)); //하나의 customer객체 저장, id 자동 할당
